    ...
    <div className='grid grid-flow-row grid-cols-7 gap-5'>
      <div className={`flex flex-col`}>
        <div className='mb-4 relative group flex flex-1'>
          <Image
            src={
              'https://www.gstatic.com/youtube/media/ytm/images/pbg/create-playlist-@210.png'
            }
            alt=''
            width={152}
            height={152}
        ...
        <div className='font-normal text-sm truncate flex-1'>새 재생목록</div>
      </div>
      <div className={`flex flex-col`}>
        <div className='mb-4 relative group flex flex-1'>
          <svg
